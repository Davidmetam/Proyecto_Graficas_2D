...
pygame.display.set_caption("Animacion Reloj de Arena 3D (Proyeccion)")
...
centro_figura_inicial = (725, 290, 75)
escala_figura = 20
...
punto_de_proyeccion = (0, 100, 300)

vertices_base, caras_base = dibujador3D.crear_reloj_arena_caras(
    centro_figura_inicial,
    escala_figura,
    t_min_figura,
    t_max_figura,
    pasos_t_figura,
